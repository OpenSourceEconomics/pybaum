...
extlinks = {
    ...
    "gh": ("https://github.com/OpenSourceEconomics/pybaum/pulls/%s", "#"),
}
...
project = "pybaum"
copyright = f"2022 - {year}, {author}"  # noqa: A001
...
try:
    release = get_distribution("pybaum").version.split("+")[0]
...
html_theme_options = {
    "github_url": "https://github.com/OpenSourceEconomics/pybaum",
}
